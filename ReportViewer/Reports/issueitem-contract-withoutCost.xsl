        ...
        <div id="printArea" class="printArea">
          ...
          <div id="container" class="container" style="padding-top:5px;">
            <table class="main-sheet" style="width: 100%;" border="0px"  cellspacing="0">
                  ...
                  <table style="width:100%" border="0">
                    <tr>
                      ...
                      <td style="text-align:center;border:0px;"  class="subheading">
                        ...
                        Material Outward Slip (Contract)
                      </td>
              ...
              <tr>
                <td style="padding:0px;border-top:0px;border-bottom:0px;">
                  <xsl:attribute name="colspan">
                    <xsl:value-of select="$mainSpan"/>
                  </xsl:attribute>
                  <table style="width:100%" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      ...
                      <td  style="max-width:100px;border:0px;"> </td>
                    </tr>
                  </table>
                </td>
              </tr>
              ...
              <tr>
                <td style="vertical-align:top;">
                  ...
                  <xsl:if test="$challanType = 1 or $challanType = 2">
                    <ul style="margin:0px;padding:0px;">
                      <li class="subheading">Customer</li>
                      <li>
                        <xsl:value-of select="NewDataSet/Header/Client"/>
                      </li>
                      <li>
                ...
                <td colspan="3" style="vertical-align:top;">
                  <xsl:if test="$challanType = 10">
                    <ul style="margin:0px;padding:0px;">
                      <li class="subheading">Delivery Address</li>
                      <li>
                        <xsl:value-of select="NewDataSet/Header/Client"/>
                      </li>
                      <li>
              ...
              <tr class="detailsRow">
                ...
                <th style="border-bottom:solid 1px;border-top:0px;width:80px;text-align:center;">HSN/SAC Code</th>
                    ...
                    <td class="noborder" style="border-bottom:solid 1px;border-right:solid 1px;text-align:center">
                      <xsl:choose>
                        <xsl:when test="Size > 0">
                          <xsl:value-of select="util:ToInt(Size)"/>
                        </xsl:when>
                        <xsl:otherwise>
                          -
                        </xsl:otherwise>
                      ...
                      <div style="display:flex;flex-direction:column;">
                        ...
                        <xsl:if test="$printWeightSetting = 'masters'">
                          <div style="text-align: center;margin-top:20px;">
                            <b>Weight (Approx)</b>
                            <br/>
                            <xsl:value-of select="util:FormatNumber(sum(NewDataSet/Table/TotalWeight))"/>
                        ...
                        <div style="text-align: center;margin-top:20px;">
                          ...
                          <br/>
                          <xsl:value-of select="util:FormatNumber(ApproximateValue)"/>
              ...
              <tr class="detailsRow">
                ...
                <td style="border:solid 1px #000;padding:5px;text-align:center;">
                  <b>
              ...
              <tr>
                <td style="border-top:solid 1px;padding:0px;">
                  ...
                  <table style="width:100%;height:100%;" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      <td class="padding noborder" style="border-top:0px;border-left:0px;border-bottom:0px;border-right:solid 1px;
                          vertical-align:top;border-right:0px;" colspan="2" >
                        ...
                        <span style="font-size:14px; margin-top:40px; ">CUSTOMER SIGNATURE</span>
                      </td>
                      ...
                      <td class="padding noborder subheading" style="border-top:0px;border-bottom:0px;vertical-align:bottom;
                          text-align:center;border-right:0px;border-left:0px;text-align:right;">
                        <table style="width:100%" border="0">
                          <tr>
                            <td class="noborder" style="text-align:center;border:0px;text-align:right; ">
                          ...
                          <tr>
                            <td class="noborder" style="text-align:center;border:0px;text-align:right;"> AUTHORIZED SIGNAORY</td>
                          </tr>
