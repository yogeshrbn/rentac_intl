          ...
          <div id="content">
            ...
            <table  border="0px"  cellspacing="0" class="table-container">
              ...
              <tbody class="table-body">
                ...
                <xsl:for-each select="NewDataSet/Table[Unit='Set']">
                  <tr>
                    <td colspan="7" class="table-cell text-center" style="font-weight:bold;">
                      <xsl:value-of select="Product" /> (<xsl:value-of select="SentQty" />) | HSN: <xsl:value-of select="HSNCode" />
                    </td>
                  </tr>
                </xsl:for-each>
                <tr>
                ...
                <tr class="table-row spacer-row">
                  <td colspan="5" class="table-cell" style="height:100px !important;font-size:8pt">
