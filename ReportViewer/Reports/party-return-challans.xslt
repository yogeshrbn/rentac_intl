          ...
          <table style="width:100%;border-collapse:collapse;">
            ...
            <tr>
              <td  style="width:20%;vertical-align:top;" class="noborder">
                <strong>TIN/CST No: </strong>    <xsl:value-of select="d/company/TIN"/>
              </td>
              <td style="width:60%;vertical-align:top;"  class="text-center noborder"  >
                <ul   style="list-style:none;padding:0px;margin-top:0px; width:100%;display:table">
                  ...
                  <li>
                    <strong>
                      (Receipt From  <xsl:value-of select="d/from"/> To  <xsl:value-of select="d/to"/>)
                    </strong>
                  </li>
                </ul>
              ...
              <td style="width:20%;vertical-align:top;" class="text-right noborder">
                <strong>Date:</strong>:    <xsl:value-of select="d/printDate"/>
              </td>
            </tr>
                  ...
                  <div style="border-bottom:dashed 1px #000;padding-bottom:10px;padding-top:10p;padding-right:10px;">
                    <table style="width:100%">
                      ...
                      <tr>
                        <td class="noborder" style="width:50%;">
                          ...
                          <strong>
                            Challan#   <xsl:text> </xsl:text><xsl:value-of select="GRN"/>
                          </strong>
                        </td>
                        <td class="noborder">
                    ...
                    <table class="table table-condensed;border-collapse:collapse;border"   cellspacing="0">
                      <tr class="headerRow">
                        ...
                        <th class="text-center" style="border:0;width:10px;" >Short</th>
                        <th class="text-center" style="border:0;width:10px;" >Scrap</th>

                        <th class="text-center" style="border:0;width:10px;" >Excess</th>
                        <th class="text-center" style="border:0;width:100px;" >Remarks</th>
                      </tr>
