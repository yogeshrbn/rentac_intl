        ...
        <div id="printArea">
          <table style="width: 100%" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td style=" text-align:right;vertical-align:top" class="noborder">
                <p style="margin:0px;padding:0px;font-size:18px;font-weight:bold;margin-bottom:5px;">PURCHASE RETURN</p>
                Receipt #: <xsl:value-of select="data/VoucherNumber" /><br />
          ...
          <table style="width:100%; border-collapse:collapse;margin-top:-1px;">
              ...
              <td colspan="3">
                <table style="width:100%;margin-top:0px;">
                  ...
                  <tr>
                    ...
                    <td class="noborder">
                      <xsl:value-of select="data/VendorCreditNoteNumber" />
                    </td>
                  </tr>
                  <tr>
                    <td class="noborder">
                    ...
                    <td class="noborder">
                      <xsl:value-of select="data/VendorCreditNoteDate" />
                    </td>
                  </tr>
                </table>
              </td>
            ...
            <tr>
              ...
              <th class="text-right" style="border-right:0px;">SubTotal</th>
              <th  class="text-right">
