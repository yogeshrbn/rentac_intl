      ...
      <body>
        <div id="printArea">
          <table style="width: 100%" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td style=" text-align:right;vertical-align:top" class="noborder">
                <p style="margin:0px;padding:0px;font-size:18px;font-weight:bold;margin-bottom:5px;">TAX INVOICE</p>
          ...
          <table style="width:100%;border-collapse:collapse;margin-top:10px;margin-top:30px;">
            ...
            <tr>
              <th class="text-right" style="border-right:0px;">
            ...
            <tr>
              <th class="text-right" style="border-top: 0px; border-right: 0px;">
