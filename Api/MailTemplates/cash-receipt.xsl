  ...
  <xsl:template match="/">
    <html xmlns="http://www.w3.org/1999/xhtml">
      ...
      <body>
        ...
        <p>
        Cash Amount <xsl:value-of select="Data/Amount"/> against Invoice Number  
            <xsl:value-of select="Data/InvoiceNumber"/> has been received and credited to your account.
            <br/>
          Ref#:  <xsl:value-of select="Data/ReceptNumber"/>
