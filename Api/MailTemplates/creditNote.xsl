  ...
  <xsl:template match="/">
    <html xmlns="http://www.w3.org/1999/xhtml">
      ...
      <body>
        ...
        <p>
          A credit note <xsl:value-of select="Data/ReceptNumber"/> against Invoice Number <b>
            <xsl:value-of select="Data/InvoiceNumber"/>
          </b> worth amount <xsl:value-of select="Data/Amount"/> has been generated.
        </p>
        
        
        <p>The document is attached with this email.</p>
