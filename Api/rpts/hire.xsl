                ...
                <td colspan="2" style="border-top:0px;" valign="top">
                  ...
                  <table id="items" style="width: 100%"  cellspacing="0">
                    <tr>
                      ...
                      <th style="border-top: 0px;border-left:0px;width:150px;text-align:right">Qty</th>
                      <th style="border-top: 0px;border-left:0px;text-align:right;border-right:0px;width:80px;padding-left:3px;padding-right:3px;">Break</th>
                    ...
                    <xsl:for-each select="NewDataSet/Table">
                      <tr>
                        ...
                        <td  style="border-top: 0px;border-left:0px;text-align:right">
                          <xsl:value-of select="Quantity" />
                        </td>
                        <td  style="border-top: 0px;border-left:0px;border-right:0px;text-align:right">
                    ...
                    <tr class="headerRow">
                      ...
                      <td style="text-align: right;border-top:0px;border-left:0px;">
                        <xsl:value-of select="format-number(sum(NewDataSet/Table/Quantity),'#.00')"/>
                      </td>
                      <td style="text-align: right;border-top:0px;border-left:0px;border-right:0px;">
                        <xsl:value-of select="format-number(sum(NewDataSet/Table/Breakage),'#.00')"/>
                      </td>
