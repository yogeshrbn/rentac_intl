              ...
              <tr>
                <td colspan="4" style="border-top: 0px; border-left: 0px; border-right: 0px;">
                  <table style="width: 100%"  cellspacing="0">
                    ...
                    <tr >
                      <td class="padding" style="width: 50%; height: 100px; border-bottom: none; border-left: none;
                        ...
                        <div style="padding:0; width:100%;">
                          <b >Customer</b>
                          <br/>
                          <table style="width:100%;margin-top:15px; border-collapse:collapse;" cellspacing="0" cellpadding="2">
