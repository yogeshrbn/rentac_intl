          ...
          <div id="container">
            <table style="width: 100%" cellpadding="0" cellspacing="0">
              ...
              <tr class="padding">
                ...
                <!--<td colspan="3" style="width: 60%; border-top: none; border-bottom: none; text-align: center;font-weight:bold">Amount Receipt</td>-->
                  ...
                  <table style="width: 100%" cellpadding="0" cellspacing="0">
                    <tr class="padding">
                      <td style="width: 50%; height: 100px; border-bottom: none; border-left: none; border-right: none; vertical-align: top;"
                          colspan="2">
                        Voucher Number: -  <xsl:value-of select="Data/ReceiptNumber"/>
                        <br />
                        Tran Ref Number: <xsl:value-of select="Data/InvoiceNumber"/>
                        <p>
