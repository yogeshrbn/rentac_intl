                  ...
                  <table style="width: 100%;" border="0px"  cellspacing="0">
                    <tr>
                      ...
                      <td class="subheading noborder" style="width:33%;text-align:right;vertical-align:bottom;border:0px">
                        Dated:-
                        <xsl:choose>
                          <xsl:when test="$printShowTimeOn and contains(string(NewDataSet/Header/StartDate), 'T')">
                            <xsl:variable name="sdStr" select="string(NewDataSet/Header/StartDate)"/>
                            <xsl:value-of select="substring-before($sdStr, 'T')"/>
                            <xsl:text> </xsl:text>
                            <xsl:variable name="tPart" select="substring-after($sdStr, 'T')"/>
                            <xsl:choose>
